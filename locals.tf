locals {
  docker_machine_userdata = var.docker_machine_docker_device == "" ? "" : ",\"amazonec2-userdata=/etc/gitlab-runner/docker-machine-user-data\""
  ...
  metrics_listen_address = var.metrics_security_group_id == "" ? "" : "listen_address = \":9999\""
