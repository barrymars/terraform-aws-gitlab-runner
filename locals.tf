locals {
  docker_machine_userdata = var.docker_machine_docker_device == "" ? "" : ",\"amazonec2-userdata=/root/docker-machine-user-data\""
  ...
  metrics_listen_address = var.metrics_security_group_id == "" ? (var.metrics_public == true ? "listen_address = \"0.0.0.0:9999\"": "") : "listen_address = \":9999\""
